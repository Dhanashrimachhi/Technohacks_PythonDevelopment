...
class App(Tk):
    ...
    def __init__(self):
        ...
        #output frame
        self.output = Frame(self, bg='blue')
        self.output.place(relx=.5, rely=.2, relwidth=.5, relheight=1)

        #response of turn check box
        self.turn_box = Label(self, bg='blue', fg='black', font=20, justify=CENTER)
        ...
        static_x = Label(self, bg='blue', text='X - points =>', font=30, fg='black', anchor='nw', justify=CENTER)
        static_x.place(relx=.5, rely=.4, relwidth=.2, relheight=.1)
        static_o = Label(self, bg='blue', text='O - points =>', fg='black', font=30, anchor='nw', justify=CENTER)
        static_o.place(relx=.5, rely=.7, relwidth=.2, relheight=.1)

        # dynamic x and o points
        self.x_points = Label(self, bg='blue', fg='white',text='0', font=30, anchor='nw', justify=CENTER)
        self.x_points.place(relx=.7, rely=.4, relwidth=.1, relheight=.1)

        self.o_points = Label(self, bg='blue',text='0', fg='white', font=30, anchor='nw', justify=CENTER)
